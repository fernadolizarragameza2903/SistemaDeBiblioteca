...
- **PostgreSQL** como base de datos relacional para el entorno principal
- **Spring Boot 4.1.1** como framework principal del proyecto
- **Java 21** como lenguaje base de desarrollo
- **Thymeleaf** para la generación de vistas del lado del servidor
- **Spring Data JPA / Hibernate** para la gestión de la capa de persistencia
- **Spring Web MVC** para implementar el patrón MVC en la capa web
- **H2 Database** utilizada para las pruebas automatizadas en memoria
- **Maven Wrapper** para compilar, construir y ejecutar la aplicación de forma portable
